...
public class TestLieuxSuiteQ3 {
	...
	Arret[] tabArret1 = {
	    AOrsay, AChateau, APlateau, ASupelec, AAlgo
	};
  ...
  public static Trajet mkTrajet1() throws ErreurTrajet, ErreurHeure {
   ...
   public static Trajet mkTrajet1b() throws ErreurTrajet, ErreurHeure {
	...
	ArrayList<Etape> res = new ArrayList<Etape>();
	res.add(new Etape(OrsayVille, AOrsay,  APieds.getInstance(), dep));
	res.add(new Etape(AOrsay, ASupelec,  EnBus.getInstance(L1), new Heure(8, 45)));
   ...
   public static Trajet mkTrajet4b() throws ErreurTrajet, ErreurHeure {
	...
	ArrayList<Etape> res = new ArrayList<Etape>();
	res.add(new Etape(OrsayVille, AOrsay, APieds.getInstance(), dep));
	res.add(new Etape(AOrsay, APlateau,  EnBus.getInstance(L1), new Heure(8, 45)));
	res.add(new Etape(APlateau, ASupelec, EnBus.getInstance(L2), new Heure(9, 8)));
    ...
    public static Trajet mkTrajet4c() throws ErreurTrajet, ErreurHeure {
       ...
       ArrayList<Etape> res = new ArrayList<Etape>();
       res.add(new Etape(OrsayVille, AOrsay, APieds.getInstance(), dep));
       res.add(new Etape(AOrsay, AChateau, APieds.getInstance(), new Heure(8, 41)));
       res.add(new Etape(AChateau, APlateau, APieds.getInstance(), new Heure(8, 56)));
       res.add(new Etape(APlateau, ASupelec, APieds.getInstance(), new Heure(9, 26)));
    ...
    public static Trajet mkTrajet5() throws ErreurTrajet, ErreurHeure {
       ...
       res.add(new Etape(OrsayVille, AOrsay, APieds.getInstance(), dep));
       res.add(new Etape(AOrsay, APlateau, EnBus.getInstance(L1), new Heure(9, 0)));
       res.add(new Etape(APlateau, Supelec, APieds.getInstance(), new Heure(9, 8)));
       res.add(new Etape(Supelec, ASupelec, APieds.getInstance(), new Heure(9, 35)));
       res.add(new Etape(ASupelec, AAlgo, EnBus.getInstance(L1), new Heure(10, 15)));
   ...
   public static Trajet mkTrajet5b() throws ErreurTrajet, ErreurHeure {
       ...
       res.add(new Etape(APlateau, ASupelec, EnBus.getInstance(L1), new Heure(9, 38)));
       res.add(new Etape(ASupelec, AAlgo, EnBus.getInstance(L1), new Heure(10, 15)));
   ...
   public static Trajet mkTrajet5c() throws ErreurTrajet, ErreurHeure {
       ...
       ArrayList<Etape> res = new ArrayList<Etape>();
       res.add(new Etape(OrsayVille, AOrsay, APieds.getInstance(), dep));
       res.add(new Etape(AOrsay, AChateau, APieds.getInstance(), new Heure(8, 48)));
       res.add(new Etape(AChateau, APlateau, EnBus.getInstance(L1), new Heure(9,3 )));
       res.add(new Etape(APlateau, AAlgo, EnBus.getInstance(L1), new Heure(9, 8)));
    ...
    public static Trajet mkTrajet5d() throws ErreurTrajet, ErreurHeure {
       ...
       res.add(new Etape(AOrsay, AChateau, APieds.getInstance(), new Heure(8, 41)));
       res.add(new Etape(AChateau, APlateau, APieds.getInstance(), new Heure(8, 56)));
       res.add(new Etape(APlateau, AAlgo, EnBus.getInstance(L1), new Heure(9, 26)));
